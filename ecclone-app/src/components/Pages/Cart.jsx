...
const Cart = () => {
  ...
  return (
    <div className="bg-bgLightPink">
      ...
      <Link to="/shop">
        <p className="font-poppins text-xxs text-linkTealGreen underline mt-4 mb-2 hover:no-underline">
          Continue shopping
        </p>
      </Link>
      {/* CART ITEMS */}
      ...
      >
        ...
        <div className={`${showPromo ? "block mb-2" : "hidden"}`}>
          <div className="flex flex-row justify-between items-center space-x-20 mb-1 pt-1.5">
            ...
            ></input>
            <button className="text-fontExtraLightGrey hover:text-fontDarkGrey border-[1px] border-fontDarkGrey font-semibold py-2 px-6 rounded-sm text-xxs md:text-xs">
              APPLY
            </button>
          </div>
